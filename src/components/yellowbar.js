...
export default function yellowbar(){
    return(
        <div className="container">
                ...
                <ul className ="drop_down">
                    ...
                    <li className = "sub">                            
                        ...
                        <ul className="sub_menu">
                            ...
                            <li>
                                <a href="http://www.abcmartkorea.com/%ed%9a%8c%ec%82%ac%ec%97%b0%ed%98%81/">회사연혁</a>                                </li>
                            <li>
            ...
            <iframe width="100%" height="854px" src="https://www.youtube.com/embed/ziTCRJvmcJ4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
